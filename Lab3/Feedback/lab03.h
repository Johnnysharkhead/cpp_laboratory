...
public:
    ...
    myList(myList&& other) noexcept; // Move constructor(assign values to an empty list)
    ...
    myList& operator= (myList&& other) noexcept; // Move assginment operator(consideration needs to be given to the release of the current list resources) 
    ...
    std::string printTest() const; // Only for test use in test.cc
